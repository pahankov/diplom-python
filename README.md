...
5. Создайте файл `social_network/local_settings.py` со следующими настройками:
```python
# Database settings
DATABASES = {
    'default': {
        ...
        'NAME': 'social_network',
        'USER': 'postgres',
        'PASSWORD': 'ваш_пароль',  # Укажите ваш пароль от PostgreSQL
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
SECRET_KEY = 'ваш_секретный_ключ'  # Сгенерируйте новый секретный ключ
